...
public class OpenAPIDocumentationConfig {
	...
	public OpenAPI openApi() {
		return new OpenAPI().info(new Info().title("PruebaTecnicaES").description("Microservicio")
				...
				.contact(new io.swagger.v3.oas.models.info.Contact().name("Angélica Macías Sánchez")
						.email("angelica.macias.sa91@gmail.com").url("https://ec.linkedin.com/in/angelica-mac%C3%ADas-s%C3%A1nchez-808464171")));
	}
